...
video_path=r"C:\Users\17555\Desktop\final_video.mp4"
audio_path=r"C:\Users\17555\Desktop\audio.wav"
...
def text_to_speech(texts,reference_audio="音色克隆样本.wav",top_k=5,top_p=1,temperature=1):#接收一个字符串列表
    name_list=[];
    ...
    for text in texts:
        params = {
            ...
            'prompt_text': '周深唱成这样，好听是好听，厉害听起来也很厉害，但他如果是女生，就很普通。这是在否定我在音乐上做的一切努力。'
        }
...
# API 路由
@app.post("/process/")
def process_video(video_path:str,output_path:str,reference_audio:str,top_k:int,top_p:int):
    try:
        print("1. 正在提取音频...")
        ...
        print("4. 正在合成语音...")
        audio_segments = text_to_speech(translated_texts,reference_audio,top_k, top_p)
        ...
        print("6. 正在替换视频音频...")
        replace_audio(video_path, final_audio, output_path)

        return {"message": "处理完成", "output_path": output_path}
